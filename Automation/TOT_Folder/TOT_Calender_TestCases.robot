...
*** Test Cases ***
 Verify that the user can create Time Off from the Calendar page.
        [Documentation]   Verify that the user can create Time Off from the Calendar page.
        [Tags]      Unit
        Sleep    5s
        ...
        Wait Until Element Is Visible    xpath=//android.widget.TextView[@text="${START_DATE}"]    20s
        Click Element   xpath=//android.widget.TextView[@text="${START_DATE}"]
        Sleep    5s
...
#        Click Element       xpath=//android.widget.TextView[@text="${FIRST_QUART}"]
 ...
 Verify that the user can view scheduled time off from the Activity tab
        [Documentation]   Verify that the user can view scheduled time off from the Activity tab.
        [Tags]      Unit    Smoke
