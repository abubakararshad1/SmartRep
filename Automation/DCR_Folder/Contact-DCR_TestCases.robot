...
Verify that the user can update the Contact information through the DCR
    [Documentation]    Verify that the user can update the Contact information through the DCR
    [Tags]    Unit
    Sleep        5s
...
Verify that the user can View the DCR detail of the updated Contact
    [Documentation]    Verify that the user can View the DCR detail of the updated Contact
    [Tags]    Unit
    Sleep    10s
