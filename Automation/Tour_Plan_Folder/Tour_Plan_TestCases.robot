...
*** Test Cases ***
Verify that the user can create Tour Plan from the Contact tab
    [Documentation]   Verify that the user can create Tour Plan from the Contact tab
    [Tags]      Unit
...
View Tour Plan
    [Documentation]   Verify that the user can View Tour Plan from the Activity tab
    [Tags]      Regsression
