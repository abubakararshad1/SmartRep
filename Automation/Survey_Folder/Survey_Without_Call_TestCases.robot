...
*** Test Cases ***
Verify that the user can answer the questions of Survey Without Call.
    [Documentation]   Verify that the user can answer the questions of Survey Without Call.
    [Tags]      Unit
