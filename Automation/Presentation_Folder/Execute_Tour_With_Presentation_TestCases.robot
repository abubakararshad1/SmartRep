...
*** Test Cases ***
Verify tha the user can Executes a Tour with selected contact, enters tour execution details, runs presentation, and verifies from Activity tab.
    [Documentation]    Verify tha the user can Executes a Tour with selected contact, enters tour execution details, runs presentation, and verifies from Activity tab.
    ...
    # Click on "Presentation_Folder" tab
...
#View the Executed Tour With Presentation_Folder edetailing
