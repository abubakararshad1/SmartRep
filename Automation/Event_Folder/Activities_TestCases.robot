...
*** Test Cases ***
Verify that the user can View the schedule event based on the Excel
    [Documentation]    Verify that the user can View the schedule event based on the Excel
    [Tags]    Smoke
    Sleep    2s
