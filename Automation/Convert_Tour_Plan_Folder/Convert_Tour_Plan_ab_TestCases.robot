...
Verify that the user can Convert the Tour Plan and execute the Tour
    [Documentation]    Verify that the user can Convert the Tour Plan and execute the Tour
    [Tags]    Regression
    # Open Activities tab
...
#   Swipe to Show Survey_Folder Questions
    ...
    # Wait and Click on Product Survey_Folder Tab
...
#    Click Element    xpath=//android.widget.TextView[@text="Product Effectiveness & Prescription Survey_Folder"]
#    Sleep    5s
    ...
    # Wait and Click on S&T Survey_Folder Tab
...
#    Click Element    xpath=//android.view.ViewGroup[@content-desc="Pharma Product Distribution & Demand Survey_Folder(ENT)"]/android.view.ViewGroup/com.horcrux.svg.SvgView
#    Sleep    5s
...
Verify that the user can View the Executed Tour
    [Documentation]    Verify that the user can View the Executed Tour
    [Tags]    Regression
    Open Workbook       ${EXCEL_PATH}
